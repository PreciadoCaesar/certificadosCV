...
const CERTIFICATE_BASE_URL = 'https://certificados.consigueventas.com/';
        ...
        .then(resp => {
            ...
            image.onload = function () {
               ...
               ctx.font = '20px Arial';
                ...
                ctx.fillText(
                    `participado en el programa de competencias profesionales, con una duración de ${data.Horas} horas,`,
                    x,
                    yTexto1 + 30
                );
