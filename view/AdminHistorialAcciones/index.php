...
<head>
    ...
    <title>Gestión de Historial de Acciones</title>
...
<body>
    <div class="app-layout">
        ...
        <?php require_once BASE_PATH . '/view/moduls_page/historial/main.php'; ?>
    </div>

    <?php
      require_once BASE_PATH . '/view/moduls_page/historial/main.php';
      require_once BASE_PATH . '/view/html/MainJs.php';
    ?>

    <script src="<?= BASE_URL ?>/view/moduls_page/historial/historial.js"></script>
      <script>
