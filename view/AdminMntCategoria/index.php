...
<body>
    <div class="app-layout">
        ...
        <?php require_once BASE_PATH . '/view/moduls_page/categorias/main.php'; ?>
    </div>

    <?php
      require_once BASE_PATH . '/view/moduls_page/categorias/modal_categoria.php';
      require_once BASE_PATH . '/view/moduls_page/categorias/main.php';
      require_once BASE_PATH . '/view/html/MainJs.php';
    ?>

    <script src="<?= BASE_URL ?>/view/moduls_page/categorias/categorias.js"></script>
      <script>
