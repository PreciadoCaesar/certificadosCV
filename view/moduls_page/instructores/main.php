    ...
    <main class="main-content" role="main">
        <section class="section-header">
            <div class="section-header__text">
                ...
                <p class="section-header__description">Aquí podrá gestionar la lista completa de instructores registrados</p>
            </div>
             <?php if (
        ...
        <section class="data-table-section" aria-labelledby="table-caption">
            <div class="table-container">
                <table id="instructor_data" class="data-table" role="grid" aria-describedby="table-caption">
