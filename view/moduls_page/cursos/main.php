    ...
    <main class="main-content" role="main">
        ...
        <section class="data-table-section" aria-labelledby="table-caption">
            <div class="table-container">
                <table id="cursos_data" class="data-table" role="grid" aria-describedby="table-caption">
                    <caption id="table-caption" class="visually-hidden">Tabla de cursos registrados</caption>
                    <thead class="data-table__header">
                        ...
                        <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                            <span class="data-table__th-text">Categoria</span>
                        </th>
                        <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                            <span class="data-table__th-text">Nombre del Curso</span>
                        </th>
                        <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                            <span class="data-table__th-text">Fecha de Inicio</span>
                        </th>
                        <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                            <span class="data-table__th-text">Fecha de Finalización</span>
                        </th>
                        <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                         ...
                         <?php if (
                            ...
                            <th scope="col" class="data-table__th">Fondo del Certificado</th>
