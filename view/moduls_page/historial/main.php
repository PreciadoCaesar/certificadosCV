    ...
    <main class="main-content" role="main">
        <section class="section-header">
            <div class="section-header__text">
                <h2 class="section-header__title">Historial</h2>
                <p class="section-header__description">Aquí podrá visualizar todas las acciones realizadas de la plataforma</p>
            </div>
        </section>
        ...
        <nav class="controls-bar" aria-label="Controles de tabla de categorías">
            ...
            <div class="controls-bar__filters">
                <div class="text-input-wrapper">
                    ...
                    <input type="text" class="text-input" placeholder="Buscar Historial" id="search-user-input">
                </div>
            </div>
        </nav>

       <section class="data-table-section" aria-labelledby="table-caption-categorias">
            <div class="table-container">
                <table id="log_data" class="data-table" role="grid" aria-describedby="table-caption-categorias">
                    <caption id="table-caption-categorias" class="visually-hidden">Tabla de categorías registradas</caption>
                    <thead class="data-table__header">
                        <tr>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">N°_Historial</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Administrador</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Modulo</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">N° Registro</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Acciones Realizadas</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Datos Anteriores</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Datos Nuevos</span>
                            </th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none">
                                <span class="data-table__th-text">Fecha</span>
                            </th>
                        </tr>
                    </thead>
