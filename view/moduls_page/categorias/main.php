    ...
    <main class="main-content" role="main">
        <section class="section-header">
            <div class="section-header__text">
                ...
                <p class="section-header__description">Aquí podrá gestionar la lista completa de categorías</p>
            </div>
            <?php if (
       ...
       <section class="data-table-section" aria-labelledby="table-caption-categorias">
            <div class="table-container">
                <table id="categoria_data" class="data-table" role="grid" aria-describedby="table-caption-categorias">
