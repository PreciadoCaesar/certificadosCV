    ...
    <div class="page-header-content">
        <div class="page-header-content__left">
            <h1 class="page-header-content__title">
                <span class="material-symbols-outlined page-header-content__icon" aria-hidden="true">note_alt</span>
    ...
    <main class="main-content" role="main">
        <section class="section-header">
            <div class="section-header__text">
                <h2 class="section-header__title">Certificados</h2>
                <p class="section-header__description">Aquí podrá gestionar la lista completa de certificados emitidos</p>
            </div>
        ...
        <nav class="controls-bar" aria-label="Controles de tabla de certificados">
            <div class="controls-bar__filters-end">
                <div class="select-wrapper">
                    <select class="select-input" id="cur_id" name="cur_id" aria-label="Seleccionar Curso"></select>
                </div>
            </div>
            <div class="controls-bar__actions-column" role="toolbar" aria-label="Herramientas de exportación" id="navbar-certificado">
                <nav class="controls-bar-button" aria-label="Controles de tabla de usuarios">
                    <div class="text-input-wrapper">
                        ...
                        <input type="text" class="text-input" placeholder="Buscar Certificado" id="search-table-principal">
                    </div>
                    ...
                    <?php if ((isset($_SESSION["rol"]) && $_SESSION["rol"] === "gerente") || (isset($_SESSION["rol"], $_SESSION["tipo_permiso"]) && $_SESSION["rol"] === "admin" && $_SESSION["tipo_permiso"] == 1)): ?>
        ...
        <section class="data-table-section" aria-labelledby="table-caption" id="data-table-section">
            <div class="table-container">
                <table id="detalle_data" class="data-table" role="grid" aria-describedby="table-caption">
                    ...
                    <!-- Definición de anchos por columna (ajustables desde este archivo) -->
                    <colgroup>
                        <col style="width:20%" /> <!-- Curso -->
                        <col style="width:30%" /> <!-- Usuario -->
                        <col style="width:12%" /> <!-- Fecha de Emisión -->
                        <col style="width:12%" /> <!-- Fecha de Vencimiento -->
                        <col style="width:12%" /> <!-- Instructor -->
                        <?php if ((isset($_SESSION["rol"]) && $_SESSION["rol"] === "gerente") || (isset($_SESSION["rol"], $_SESSION["tipo_permiso"]) && $_SESSION["rol"] === "admin" && $_SESSION["tipo_permiso"] == 1)): ?>
                            <col style="width:6%" /> <!-- Ver Certificado -->
                            <col style="width:2%" /> <!-- Opciones -->
                        <?php endif; ?>
                    </colgroup>
                    <thead class="data-table__header">
                        <tr>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none"><span class="data-table__th-text">Curso</span></th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none"><span class="data-table__th-text">Usuario</span></th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none"><span class="data-table__th-text">Fecha de Emisión</span></th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none"><span class="data-table__th-text">Fecha de Vencimiento</span></th>
                            <th class="data-table__th data-table__th--sortable" role="columnheader" aria-sort="none"><span class="data-table__th-text">Instructor</span></th>
                            <?php if ((isset($_SESSION["rol"]) && $_SESSION["rol"] === "gerente") || (isset($_SESSION["rol"], $_SESSION["tipo_permiso"]) && $_SESSION["rol"] === "admin" && $_SESSION["tipo_permiso"] == 1)): ?>
                    ...
                    <tbody class="data-table__body" id="certificate-table-body"></tbody>
                </table>
            </div>
        </section>

        <section class="pagination-controls" id="pagination-controls">
            <div class="pagination-controls__info">Visualizando registros del <span id="pagination-start">1</span> al <span id="pagination-end">8</span> de un total de <span id="pagination-total">8</span> registros</div>
