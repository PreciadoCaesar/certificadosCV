...
require_once BASE_PATH . '/view/html/MainHead.php'; 
...
<body>
    <div class="app-layout">
        ...
        <?php require_once BASE_PATH . '/view/moduls_page/certificados/main.php'; ?>
    </div>

    <?php
      require_once BASE_PATH . '/view/moduls_page/certificados/modal_certificado.php';
      require_once BASE_PATH . '/view/moduls_page/certificados/modal_edit.php';
      require_once BASE_PATH . '/view/html/MainJs.php';
    ?>

    <script src="<?= BASE_URL ?>/view/moduls_page/certificados/certificado.js"></script>
      <script>
