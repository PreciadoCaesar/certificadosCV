...
// Si NO existe la sesión ID_gerente, redirige
...
<body>
    <div class="app-layout">
        ...
        <?php require_once BASE_PATH . '/view/moduls_page/administrador/main.php'; ?>
    </div>

    <?php
      require_once BASE_PATH . '/view/moduls_page/administrador/modal_administrador.php';
      require_once BASE_PATH . '/view/html/MainJs.php';
    ?>

    <script src="<?= BASE_URL ?>/view/moduls_page/administrador/administrador.js"></script>
      <script>
