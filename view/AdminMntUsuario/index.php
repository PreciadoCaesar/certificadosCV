...
<body>
    <div class="app-layout">
        ...
        <?php require_once BASE_PATH . '/view/moduls_page/usuarios/main.php'; ?>
    </div>

    <?php
      require_once BASE_PATH . '/view/moduls_page/usuarios/modal_usuario.php';
      require_once BASE_PATH . '/view/html/MainJs.php';
    ?>

    <script src="<?= BASE_URL ?>/view/moduls_page/usuarios/usuarios.js"></script>


<!--Logica del menu plegable y contraible-->
    <script>
