...
// Procesa login
  if (isset($_POST['enviar']) && $_POST['enviar'] === 'si') {
    require_once 'models/Usuario.php';
    $usuario = new Usuario();
    $usuario->login(); // Debe hacer header('Location: /api/');
  }
?>
<!DOCTYPE html>
<html lang="es">
  <head>
    ...
    <title>Consigue Ventas - Log In</title>
  </head>
      ...
      <form action="" method="post">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
          ...
          <div class="signin-logo tx-center tx-28 tx-bold tx-inverse">
            <img src="public\Recurso 3CV.png" style="width: 100%;">
          </div>
            <br>
          <div class="tx-center mg-b-30">Certificados y Diplomas</div>

          <div class="form-group">
              <input type="text" id="correo" name="correo" class="form-control" placeholder="Ingrese Correo Electronico">
          </div>
          <div class="form-group">
